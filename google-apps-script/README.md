...
- `RecommendationSync.gs` — pengarah sinkronisasi Rekomendasi Pemupukan dan kompatibilitas sumber penagihan lama.
- `RecommendationMonitoringSync.gs` — pemetaan sepuluh tab monitoring regional/swasta ke kegiatan, laporan, histori, perusahaan, dan tim.
- `RecommendationWorkbook.gs` — pembentuk Google Sheet sumber monitoring dari workbook Rekomendasi Pemupukan.
...
8. Untuk Rekomendasi Pemupukan, buka **Import / Export → Sinkronkan Rekomendasi**. Sepuluh tab regional/swasta pada Google Sheet monitoring akan dipetakan ke kegiatan, laporan, histori, perusahaan, dan tim; perubahan berikutnya ditangani trigger serta pemeriksaan harian.
