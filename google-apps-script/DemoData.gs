...
function seedDemoData() {
  ...
  const grouped = {
    ...
    KEGIATAN: [
      { activity_id: 'RP-DEMO-0001', display_id: 'RP-DEMO-0001', company_id: companies[0][0], perusahaan: companies[0][1], subbagian: 'RPJID', kategori: 'RP', jenis_kegiatan: 'Rekomendasi Pemupukan 2027', regional: 'R1', kebun_lokasi: 'Kebun A', tahun: year, tanggal_surat_masuk: offsetDate_(-50), tanggal_spk: offsetDate_(-42), nilai_kontrak: 475000000, hpp: 62000000, pic: 'Dewi', status: 'AKTIF', catatan: 'DEMO / SAMPLE DATA', created_at: timestamp, updated_at: timestamp },
      { activity_id: 'BT-DEMO-0001', display_id: 'BT-DEMO-0001', company_id: companies[1][0], perusahaan: companies[1][1], subbagian: 'BT', kategori: 'BT', jenis_kegiatan: 'Evaluasi TBM Kelapa Sawit', regional: 'R2', kebun_lokasi: 'Kebun Bahagia', tahun: year, tanggal_surat_masuk: offsetDate_(-28), tanggal_spk: offsetDate_(-24), batas_akhir: offsetDate_(8), nilai_kontrak: 185000000, hpp: 38500000, pic: 'Rizal', status: 'AKTIF', catatan: 'DEMO / SAMPLE DATA', created_at: timestamp, updated_at: timestamp },
      { activity_id: 'TR-DEMO-0001', display_id: 'TR-DEMO-0001', company_id: companies[2][0], perusahaan: companies[2][1], subbagian: 'PLT', kategori: 'TR', jenis_kegiatan: 'Pelatihan Panen Presisi', regional: 'R4P', kebun_lokasi: 'Medan', tahun: year, tanggal_surat_masuk: offsetDate_(-12), nilai_kontrak: 125000000, hpp: 31000000, pic: 'Nina', status: 'AKTIF', catatan: 'DEMO / SAMPLE DATA', created_at: timestamp, updated_at: timestamp },
      { activity_id: 'JID-DEMO-0001', display_id: 'JID-DEMO-0001', company_id: companies[3][0], perusahaan: companies[3][1], subbagian: 'RPJID', kategori: 'JID', jenis_kegiatan: 'Pengadaan Automatic Weather Station', regional: 'SW', kebun_lokasi: 'Kebun Lestari', tahun: year, tanggal_surat_masuk: offsetDate_(-18), nilai_kontrak: 210000000, hpp: 118000000, pic: 'Agus', status: 'AKTIF', catatan: 'DEMO / SAMPLE DATA', created_at: timestamp, updated_at: timestamp },
      { activity_id: 'ADM-DEMO-0001', display_id: 'ADM-DEMO-0001', company_id: companies[0][0], perusahaan: companies[0][1], subbagian: 'ADM', kategori: 'LN', jenis_kegiatan: 'Pembaruan Kontrak Payung', regional: 'R1', kebun_lokasi: 'Kantor Pusat', tahun: year, tanggal_surat_masuk: offsetDate_(-9), nilai_kontrak: 0, hpp: 0, pic: 'Sari', status: 'PROSES', catatan: 'DEMO / SAMPLE DATA', created_at: timestamp, updated_at: timestamp },
    ],
    MONITORING_LAPORAN: [
      { report_id: 'LAP-RP-DEMO-0001', activity_id: 'RP-DEMO-0001', company_id: companies[0][0], perusahaan: companies[0][1], regional: 'R1', kebun: 'Kebun A', nama_kegiatan: 'Rekomendasi Pemupukan 2027', tahun: year, workflow: 'RP', tanggal_draft_masuk: offsetDate_(-35), checkpoint_terakhir: 'KOREKTOR 2 CETAK', korektor_terakhir: 'Edi Sigit', tanggal_checkpoint: offsetDate_(-4), status: 'KOREKTOR 2 CETAK', pic: 'Dewi', catatan: 'DEMO / SAMPLE DATA', created_at: timestamp, updated_at: timestamp },
      { report_id: 'LAP-BT-DEMO-0001', activity_id: 'BT-DEMO-0001', company_id: companies[1][0], perusahaan: companies[1][1], regional: 'R2', kebun: 'Kebun Bahagia', nama_kegiatan: 'Evaluasi TBM Kelapa Sawit', tahun: year, workflow: 'BT', tanggal_draft_masuk: offsetDate_(-26), checkpoint_terakhir: 'DIREVISI', korektor_terakhir: 'Josep', tanggal_checkpoint: offsetDate_(-2), tanggal_revisi: offsetDate_(-2), status: 'DIREVISI', pic: 'Rizal', catatan: 'DEMO / SAMPLE DATA', created_at: timestamp, updated_at: timestamp },
      { report_id: 'LAP-JID-DEMO-0001', activity_id: 'JID-DEMO-0001', company_id: companies[3][0], perusahaan: companies[3][1], regional: 'SW', kebun: 'Kebun Lestari', nama_kegiatan: 'Dokumentasi Instalasi AWS', tahun: year, workflow: 'UMUM', tanggal_draft_masuk: offsetDate_(-18), checkpoint_terakhir: 'DIKOREKSI', korektor_terakhir: 'Desra', tanggal_checkpoint: offsetDate_(-5), status: 'DIKOREKSI', pic: 'Agus', catatan: 'DEMO / SAMPLE DATA', created_at: timestamp, updated_at: timestamp },
      { report_id: 'LAP-TR-DEMO-0001', activity_id: 'TR-DEMO-0001', company_id: companies[2][0], perusahaan: companies[2][1], regional: 'R4P', kebun: 'Medan', nama_kegiatan: 'Laporan Pelatihan Panen Presisi', tahun: year, workflow: 'UMUM', tanggal_draft_masuk: offsetDate_(-40), tanggal_kirim: offsetDate_(-12), tanggal_net: offsetDate_(-13), checkpoint_terakhir: 'NET / RP27', rp27: 'RP27_Pelatihan_PTPN_Medan', status: 'NET / RP27', pic: 'Nina', catatan: 'DEMO / SAMPLE DATA', created_at: timestamp, updated_at: timestamp },
    ],
    ANALISIS_LAB: [
      { lab_id: 'LAB-DEMO-0001', company_id: companies[0][0], perusahaan: companies[0][1], activity_id: 'RP-DEMO-0001', kebun: 'Kebun A', jenis_analisis: 'DAUN', jumlah_kcd: 128, tahun: year, tanggal_sampel_masuk: offsetDate_(-14), tanggal_mulai_proses: offsetDate_(-12), status: 'PROSES', pic: 'Budi', catatan: 'DEMO / SAMPLE DATA', created_at: timestamp, updated_at: timestamp },
    ...
    TRANSAKSI_JID: [
      { transaction_id: 'JID-DEMO-0001', product_id: 'PRD-DEMO-0003', company_id: companies[3][0], perusahaan: companies[3][1], activity_id: 'JID-DEMO-0001', tanggal: offsetDate_(-18), jumlah: 2, harga_satuan: 70000000, nilai: 140000000, status_tagihan: 'BELUM DITAGIH', pic: 'Agus', created_at: timestamp, updated_at: timestamp },
